...
// UUID Management - Username to UUID mapping for skin persistence
export function GetCurrentUuid() {
    return callBackend('GetCurrentUuid');
}

export function GetUuidForUser(username) {
    return callBackend('GetUuidForUser', username);
}

export function GetAllUuidMappings() {
    return callBackend('GetAllUuidMappings');
}

export function SetUuidForUser(username, uuid) {
    return callBackend('SetUuidForUser', username, uuid);
}

export function DeleteUuidForUser(username) {
    return callBackend('DeleteUuidForUser', username);
}

export function ResetCurrentUserUuid() {
    return callBackend('ResetCurrentUserUuid');
}

export function SwitchToUsername(username) {
    return callBackend('SwitchToUsername', username);
}

export function RecoverOrphanedSkinData() {
    return callBackend('RecoverOrphanedSkinData');
}

export function GetOrphanedSkinUuid() {
    return callBackend('GetOrphanedSkinUuid');
}
