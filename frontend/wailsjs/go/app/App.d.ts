...
export function GetCurrentUuid():Promise<string>;

export function GetUuidForUser(username:string):Promise<string>;

export function GetAllUuidMappings():Promise<Array<UuidMapping>>;

export function SetUuidForUser(username:string, uuid:string):Promise<boolean>;

export function DeleteUuidForUser(username:string):Promise<boolean>;

export function ResetCurrentUserUuid():Promise<string>;

export function SwitchToUsername(username:string):Promise<string|null>;

export function RecoverOrphanedSkinData():Promise<boolean>;

export function GetOrphanedSkinUuid():Promise<string|null>;
