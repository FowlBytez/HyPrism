...
SOURCE: Services/Core/Ipc/ (@type + @ipc annotations)
*/
...
const _settings = {
  ...
  setInstanceDir: (data?: unknown) => invoke<{ success: boolean, path: string }>('hyprism:settings:setInstanceDir', data),
  setLauncherDataDir: (data?: unknown) => invoke<{ success: boolean }>('hyprism:settings:setLauncherDataDir', data),
...
const _instance = {
  ...
  setIcon: (data?: unknown) => invoke<boolean>('hyprism:instance:setIcon', data),
  rename: (data?: unknown) => invoke<boolean>('hyprism:instance:rename', data),
