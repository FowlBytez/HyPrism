...
- Profile management: `GetProfiles`, `CreateProfile`, `DuplicateProfile`, `DuplicateProfileWithoutData`, `SwitchProfile`, `DeleteProfile`, `UpdateProfile`, `SaveCurrentAsProfile`, `OpenCurrentProfileFolder`
...
- Mods / Mod Manager: `SearchMods`, `GetModFiles`, `GetModCategories`, `InstallModFileToInstance`, `UninstallInstanceMod`, `CheckInstanceModUpdates`, `InstallLocalModFile`, `InstallModFromBase64`, `ExportModsToFolder`, `ImportModList`, `ExportModList`, `InstallOptimizationMods`
...
- Wrapper: `WrapperGetStatus`, `WrapperInstallLatest`, `WrapperLaunch`
