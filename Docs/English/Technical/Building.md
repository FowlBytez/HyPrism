...
# Flatpak
- Build manifest (canonical source): `Properties/linux/flatpak/com.hyprismteam.hyprism.yml`
- Flatpak metadata (desktop, metainfo, icon, wrapper) are canonicalized under `Properties/linux/flatpak/` — edit those files there.
