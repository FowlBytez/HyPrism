...
L.push(`// ═══════════════════════════════════════════════════════════════════`);
L.push(`// AUTO-GENERATED by Scripts/generate-ipc.mjs — do NOT edit manually`);
...
L.push(`// ─── Types (from @type annotations) ────────────────────────────`);
L.push(``);
...
L.push(`// ─── Typed IPC API (from @ipc annotations) ─────────────────────`);
L.push(``);
